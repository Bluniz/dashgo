...
// Lazy Loading, carregar um componente de forma dinâmica.
//! Recebe como primeiro parametro que recebe a importação que deve acontecer
/*
? ssr = desliga o server side rendering, ou seja só vai 
?ser carregado pelo lado do browser
*/
